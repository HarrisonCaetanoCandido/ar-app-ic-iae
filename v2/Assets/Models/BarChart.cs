...
public class BarChart : MonoBehaviour, IObserver
{
    ...
    private void SetBarChart()
    {
        ...
        for (i = 0; i < barData.Count; i++)
        {
            ...
            label.transform.localPosition = new Vector3(i * barSpacing, 5.0f, 5.0f);
            // Rotaciono o texto para garantir que ele esteja visível e virado corretamente para a camera
            label.transform.localEulerAngles = new Vector3(0, 0, 0);
            // Reescalo a label para aparecer maior na cena
            label.transform.localScale = new Vector3(1.0f, 0.2f, 1.0f);
            ...
            // Defino o tamanho dos caracteres
            textMesh.characterSize = 0.5f; 
            // Defino o tamanho da fonte
    ...
    void OnDrawGizmos()
    {
        foreach (var bar in bars)
        {
            ...
            Gizmos.DrawWireSphere(bar.transform.position, 0.1f);
        }
    }
}
